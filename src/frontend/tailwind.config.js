  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        gold: "0 0 30px oklch(0.76 0.12 82 / 15%), 0 0 60px oklch(0.76 0.12 82 / 08%)",
        "gold-sm": "0 0 12px oklch(0.76 0.12 82 / 20%)",
        card: "0 4px 24px oklch(0 0 0 / 40%), 0 1px 4px oklch(0 0 0 / 30%)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
